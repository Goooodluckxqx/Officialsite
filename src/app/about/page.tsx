...
export default function AboutPage() {
  return (
    <main className="bg-cream">
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-oat/10 via-cream to-oat/10 pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-chocolate mb-6 leading-tight">
              ...
              <span className="text-milktea">Freedom in Resting</span>
            </h1>
      ...
      <section className="py-20 bg-cream">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-chocolate mb-8 text-center">
              The Story Behind Our Brand
            </h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-chocolate/80 leading-relaxed mb-6">
                <strong className="text-chocolate">Nazzle</strong> comes from <em>Nuzzle</em> — the gentle gesture of nestling close with the tip of your nose.
                <br />
                <strong className="text-chocolate">Nest</strong> is a sanctuary — a place where you can rest comfortably and safely.
              </p>
              <p className="text-chocolate/80 leading-relaxed mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <motion.div
                ...
                className="bg-oat/10 rounded-2xl p-8 text-center"
              >
      ...
      {/* Team Experience */}
      <section className="py-20 bg-oat/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="bg-cream rounded-2xl p-8 md:p-12 shadow-sm">
              ...
              <p className="text-chocolate/80 leading-relaxed">
                ...
                <strong className="text-chocolate">May you be gently supported whenever and wherever you lie down, day or night.</strong>
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-serif font-semibold text-chocolate mb-1">
                  {user.title}
                </h3>
                <p className="text-milktea text-sm font-medium mb-4">
                  {user.subtitle}
                </p>
                <ul className="space-y-2">
                  {user.benefits.map((benefit, j) => (
                    <li key={j} className="flex items-start gap-2 text-chocolate/80">
                      <span className="text-milktea mt-1">✓</span>
